...
import me.e404nnf.emeraldtools.materials.iron.armor.IronArmor;
import me.e404nnf.emeraldtools.materials.iron.item.*;
import me.e404nnf.emeraldtools.materials.items.*;
import me.e404nnf.emeraldtools.materials.normal.armor.NormalArmor;
import me.e404nnf.emeraldtools.materials.normal.item.*;
import me.e404nnf.emeraldtools.materials.quartz.armor.QuartzArmor;
import me.e404nnf.emeraldtools.materials.quartz.item.*;
...
public class Main implements ModInitializer {
    ...
    public static final SwordItem EMERALD_SWORD = new SwordItem(new NormalTool(), 0, -7.2F,new Item.Settings().group(ItemGroup.COMBAT));
    public static final Picakxe EMERALD_PICKAXE = new Picakxe(new NormalTool(), -2, -8.4F,new Item.Settings().group(ItemGroup.TOOLS));
    public static final Axe EMERALD_AXE = new Axe(new NormalTool(), 2, -6,new Item.Settings().group(ItemGroup.TOOLS));
    public static final Shovel EMERALD_SHOVEL = new Shovel(new NormalTool(), -2, -6,new Item.Settings().group(ItemGroup.TOOLS));
    ...
    public static final SwordItem IRON_EMERALD_SWORD = new SwordItem(new IronTool(), 0, -7.2F,new Item.Settings().group(ItemGroup.COMBAT));
    public static final Picakxe IRON_EMERALD_PICKAXE = new Picakxe(new IronTool(), -2, -8.4F,new Item.Settings().group(ItemGroup.TOOLS));
    public static final Axe IRON_EMERALD_AXE = new Axe(new IronTool(), 2, -6,new Item.Settings().group(ItemGroup.TOOLS));
    public static final Shovel IRON_EMERALD_SHOVEL = new Shovel(new IronTool(), -2, -6,new Item.Settings().group(ItemGroup.TOOLS));
    ...
    public static final SwordItem QUARTZ_EMERALD_SWORD = new SwordItem(new QuartzTool(), 0, -7.2F,new Item.Settings().group(ItemGroup.COMBAT));
    public static final Picakxe QUARTZ_EMERALD_PICKAXE = new Picakxe(new QuartzTool(), -2, -8.4F,new Item.Settings().group(ItemGroup.TOOLS));
    public static final Axe QUARTZ_EMERALD_AXE = new Axe(new QuartzTool(), 2, -6,new Item.Settings().group(ItemGroup.TOOLS));
    public static final Shovel QUARTZ_EMERALD_SHOVEL = new Shovel(new QuartzTool(), -2, -6,new Item.Settings().group(ItemGroup.TOOLS));
    ...
    public static final SwordItem DIAMOND_EMERALD_SWORD = new SwordItem(new DiamondTool(), 0, -7.2F,new Item.Settings().group(ItemGroup.COMBAT));
    public static final Picakxe DIAMOND_EMERALD_PICKAXE = new Picakxe(new DiamondTool(), -2, -8.4F,new Item.Settings().group(ItemGroup.TOOLS));
    public static final Axe DIAMOND_EMERALD_AXE = new Axe(new DiamondTool(), 2, -6,new Item.Settings().group(ItemGroup.TOOLS));
    public static final Shovel DIAMOND_EMERALD_SHOVEL = new Shovel(new DiamondTool(), -2, -6,new Item.Settings().group(ItemGroup.TOOLS));
    public static final HoeItem EMERALD_HOE = new Hoe(new NormalTool(), 0, 0.0F, new Item.Settings().group(ItemGroup.TOOLS));
    public static final HoeItem IRON_EMERALD_HOE = new Hoe(new IronTool(), 0, 0.0F, new Item.Settings().group(ItemGroup.TOOLS));
    public static final HoeItem QUARTZ_EMERALD_HOE = new Hoe(new QuartzTool(), 0, 0.0F, new Item.Settings().group(ItemGroup.TOOLS));  
    public static final HoeItem DIAMOND_EMERALD_HOE = new Hoe(new DiamondTool(), 0, 0.0F, new Item.Settings().group(ItemGroup.TOOLS));
